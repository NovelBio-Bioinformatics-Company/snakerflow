...
public interface IMgmtQuery {
	...
	List<TaskActor> getTaskActorsByActorId(String actorId);
	/**
	 * 根据任务ID获取历史任务参与者数组
	 * @param taskId 历史任务id
	 ...
	 * @return List<Task> 活动任务集合
	 */
	Page<Task> getActiveTasks(PageModel page, QueryFilter filter);
	 ...
	 */
	Page<Order> getActiveOrders(QueryFilter filter);
	 ...
	 * @return List<Order> 活动实例集合
	 */
	Page<Order> getActiveOrders(PageModel page, QueryFilter filter);
	 ...
	 */
	Page<HistoryOrder> getHistoryOrders(QueryFilter filter);
	 ...
	 * @return List<HistoryOrder> 历史实例集合
	 */
	Page<HistoryOrder> getHistoryOrders(PageModel page, QueryFilter filter);
	 ...
	 */
	Page<HistoryTask> getHistoryTasks(QueryFilter filter);
	 ...
	 * @return List<HistoryTask> 历史任务集合
	 */
	Page<HistoryTask> getHistoryTasks(PageModel page, QueryFilter filter);
	 ...
	 */
	Page<WorkItem> getWorkItems(PageModel page, QueryFilter filter);
	 ...
	 */
	Page<HistoryOrder> getCCWorks(PageModel page, QueryFilter filter);
	 ...
	 */
	Page<WorkItem> getHistoryWorkItems(PageModel page, QueryFilter filter);
	 ...
	 * @return
	 */
	public <T> List<T> nativeQueryList(PageModel page, Class<T> T, String sql, Object... args);
}
